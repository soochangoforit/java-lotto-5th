...
public class PlayerMoneyRequest {
    ...
    public static PlayerMoneyRequest from(final String rawPlayerMoney) {
        validate(rawPlayerMoney);
        return new PlayerMoneyRequest(Long.parseLong(rawPlayerMoney));
    }

    private static void validate(final String playerMoney) {
    ...
    private static boolean isBlank(final String playerMoney) {
        return playerMoney.isBlank();
    }

    private static boolean isNumber(final String playerMoney) {
