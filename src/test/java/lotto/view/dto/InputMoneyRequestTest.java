...
class InputMoneyRequestTest {
    ...
    void isDivided메서드는_로또티켓구매_금액을_받아_로또티켓가격으로_나누어_떨어지면_true를_응답한다(InputMoneyRequest inputMoney) {

        boolean isDivided = inputMoney.isDivided(1000);
    ...
    void isDivided메서드는_로또티켓구매_금액을_받아_로또티켓가격으로_나누어_떨어지지_않으면_false를_응답한다(InputMoneyRequest inputMoney) {
        boolean isDivided = inputMoney.isDivided(1000);
